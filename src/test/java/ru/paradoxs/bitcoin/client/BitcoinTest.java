...
public class BitcoinTest {
	...
	private static final String BITCOIN_FAUCET_ADDRESS = "moRyXb7XYhF9evf3fSZBPoazeXJWXPiGUx";
	private static final String TESTNET_FAUCET_ADDRESS = "moRyXb7XYhF9evf3fSZBPoazeXJWXPiGUx";
    private static final String RPCUSER          = "admin1";        // TODO: Change to what you have in bitcoin.conf file
    private static final String RPCPASSWORD      = "123";    // TODO: Change to what you have in bitcoin.conf file
    private static final String BACKUP_DIRECTORY = "/home/user";     // TODO: Change, but never ever to your Bitcoin data directory !!
    private static final boolean IS_TESTNET = true; // TODO: Set true if you are using testnet else false if running tests against main blockchain
